  ...
  return (
    <main className={styles.page}>
      <header className={styles.topbar}>
        <Link href="/admin/pulse-control-center" className={styles.brand}>
          <span>ب</span>
            ...
            <article className={styles.panel}>
              ...
              <div className={styles.quickGrid}>
                {[
                  ...
                  ["Story جديدة", "◉", "/admin/pulse-control-center/stories"],
                  ["فعالية", "◷", "/admin/pulse-control-center/events"],
                  ["إدارة Hero", "◫", "/admin/pulse-control-center/hero"],
                  ["إصدار اليوم", "▤", "/admin/pulse-control-center/edition"],
                  ["رفع وسائط", "▧", "/admin/pulse-control-center/media"],
                ].map(([label, icon, href]) => (
